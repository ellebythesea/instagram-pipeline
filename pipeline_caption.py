...
def _carousel_slide_prompt_instructions(include_row_numbers: bool) -> str:
    ...
    return (
        ...
        "* text2 and text3 = 500 to 900 chars each when source material supports it. Do not go under 450 chars unless the row has very limited usable material\n"
        "* No em dashes\n"
        ...
        "* Use the available character space in #text2 and #text3 for concrete context, quotes, numbers, stakes, consequences, and factual detail\n"
        "* Avoid overly compressed #text2 or #text3 outputs when the transcript, caption, or reliable context provides enough material\n"

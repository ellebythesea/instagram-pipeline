...
def carousel_slide_rules() -> str:
    ...
    return (
        "APPROACH\n"
        "This is fact-based news summarization for a political news outlet — not advocacy or persuasive messaging. Draw on the source material and reliable, verifiable reporting available online — names, dates, votes, rulings, dollar amounts, official statements — and present what is factual. Verify claims against reliable reporting. Where a statement is an allegation, claim, or opinion rather than an established fact, present it as such (e.g. 'alleged', 'according to', 'reportedly') rather than asserting it as verified. Do not adopt or amplify partisan framing and never invent, exaggerate, or spin facts.\n"
        "ENGAGEMENT: This is short-form social content that has about 3 seconds to earn attention, so it must be genuinely engaging — lead with the single most striking, surprising, or high-stakes REAL detail (a number, a direct quote, a concrete consequence, a sharp contradiction) and write it so a scroller stops. Engaging comes from surfacing the strongest true fact and stating it vividly, never from hype, loaded framing, or anything made up. If a detail isn't verified, don't use it to hook.\n\n"
        ...
        "* quote: the strongest scroll-stopping hook that captures the central verified fact, development, finding, or consequence from the content — the one real detail most likely to make someone stop in 3 seconds. Under 120 chars. No quotation marks, no attribution. This is the large-format display line on slide 1 — it does not need to be verbatim from the transcript. Make it specific, vivid, and factually grounded (never hyped or invented). If a verbatim line is genuinely the strongest choice, use it; otherwise write the most precise factual version of the central point.\n"
        "* text1: engaging opening headline that names the person and lands the central fact, development, or stakes without repeating the quote. Under 150 chars. Single paragraph.\n"
        ...
        "STYLE\n"
        "Write like a sharp political news outlet built for social: factual and precise, but punchy and engaging — report the facts, don't persuade or spin.\n"
        "Use names, numbers, dates, quotes, conflicts, and consequences. Prefer concrete, specific facts over abstract framing — specifics are what make it both credible and gripping.\n"

...
def _carousel_slide_prompt_instructions(include_row_numbers: bool) -> str:
    ...
    return (
        ...
        + "* text2 and text3 should usually be 350 to 750 chars, depending on source strength\n"
        ...
        + "* text2 = quote heavy slide with 2 to 4 short direct quotes when strong quotes exist\n"
        + "* text3 = broader context, stakes, political backdrop, public reaction, historical comparison, or real world impact\n"

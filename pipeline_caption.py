...
def _carousel_slide_prompt_instructions(include_row_numbers: bool) -> str:
    ...
    return (
        ...
        "* text2 and text3 should usually land between 350 and 750 chars depending on source strength\n"
        "* Never add filler, repeated framing, repeated disclaimers, or repeated facts just to increase length\n"
        "* Shorter is better when the source material is thin\n"
        "* text2 should be the most quote heavy slide when strong transcript quotes exist\n"
        "* text3 should focus on broader context, stakes, political backdrop, public reaction, historical comparison, or real world impact connected to the story\n"
        "* Avoid obvious framing phrases like 'this matters because' or 'why this matters'\n"
        "* Assume the viewer already read previous slides\n"
        "* Every slide must introduce new information, quotes, stakes, or context\n"
        "* No em dashes\n"
        ...
        "* Never restate the same fact, quote, setup, or accusation across text1, text2, and text3\n"
        ...
        "* Use #text2 as the quote heavy slide. Include 2 to 4 short direct quotes when available, connected naturally in one tight paragraph\n"
        "* Use #text3 for broader context, stakes, political backdrop, public reaction, historical comparison, or real world impact connected to the story\n"
        "* Do not use phrases like 'this matters because,' 'why this matters,' or 'the reason this is important'\n"
        ...
        "* Prefer tighter, stronger slides over full character usage\n"
        "* Do not pad text2 or text3 to reach a target length\n"
        ...
        "* text2 should carry the most quoted material when the transcript has strong lines\n"
        "* text3 may use fewer quotes if context explains the stakes more naturally\n"
    )

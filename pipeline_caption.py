...
def carousel_slide_rules() -> str:
    ...
    return (
        ...
        "BANNED PHRASES: the argument is, the claim is, the warning is, the headline says, the headline reads, the article says, the article states, the article reads, the speaker says, the clip says, the video says, the post says, according to the post, the caption reads, the speaker, the transcript, the creator said, the comment says, the post points out, the post notes, this matters because, why this matters, the carousel, the carousel opens, the carousel begins, the first slide, the second slide, the third slide, the opening slide, opens with, this slide, the post opens\n\n"

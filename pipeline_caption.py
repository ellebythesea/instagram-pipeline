...
def carousel_slide_rules() -> str:
    ...
    return (
        ...
        "ATTRIBUTION: When referring to the person or account behind the content, use their name from speaker_name when provided. If no speaker_name is given, use the @username handle (e.g. '@unitingnow argues', '@grahamformaine says'). Never use 'the video', 'the reel', 'the clip', 'the speaker', 'the creator', or 'the account' as a stand-in for a person or source.\n"
